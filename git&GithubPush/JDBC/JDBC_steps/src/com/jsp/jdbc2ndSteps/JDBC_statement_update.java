...
public class JDBC_statement_update {
	public static void main(String[] args) {
		...
		try {
			...
			int rowUpdate= statement.executeUpdate("UPDATE STUDENT SET studentMarks=90 WHERE studentId=202 ");

			//Steps 5 :- PROCESS THE RESULT
			
			System.out.println("Return type Checked of executeUpdate method:- "+rowUpdate);
